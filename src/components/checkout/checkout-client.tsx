...
import type { EventItem, TicketType } from "@/lib/mock-data";
import {
  Select,
  SelectContent,
  SelectItem,
...
function parseUGXPrice(price: string) {
...
export default function CheckoutClient({
  ...
  const ticketUnitPrice = parseUGXPrice(ticket.price);
        ...
        <div className="space-y-6 lg:col-span-8">
          ...
          <Card className="border-white/10 bg-white/[0.04] text-white backdrop-blur-xl">
            <CardContent className="p-6">
              ...
              <div className="mt-6 flex flex-col gap-5 rounded-lg border border-white/10 bg-white/[0.03] p-5 md:flex-row md:items-center md:justify-between">
                <div>
                ...
                {paymentMethod === "mobile_money" && (
                  <div className="grid gap-5 md:grid-cols-2">
                    <div>
                      ...
                      >
                        <SelectTrigger className="mt-2 min-h-11 w-full border-white/10 bg-[#0d141d] text-white placeholder:text-slate-600 rounded-sm">
          ...
          <Card className="sticky py-0 top-28 border-white/10 bg-white/[0.04] text-white backdrop-blur-xl">
            <CardContent className="p-6">
              ...
              <Button
                ...
                className="mt-8 w-full bg-violet-500 py-6 text-base font-bold hover:bg-violet-400 rounded-md text-white"
              >
  ...
  return (
    <div>
      ...
      <Input
        ...
        className="mt-2 h-11 border-white/10 bg-[#0d141d] text-white placeholder:text-slate-600 rounded-sm"
      />
    </div>
  );
}
